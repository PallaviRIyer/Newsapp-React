...
export class News extends Component {
    ...
    async updateNews(){
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=a369e55a4b8b42abb66fab0606fc0bbd&page=${this.state.page}&pageSize=${this.props.pageSize}`;
